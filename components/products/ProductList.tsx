                ...
                <FormGroup className="w-75 mx-auto mb-5">
                    <div className="row align-items-end justify-content-between">
                        <div className="col-4">
                            ...
                            <Input id="searchType" name="searchType" type="select" value={searchType} onChange={event => setSearchType(event.target.value)}>
                                <option value="">
                                    ...
                                </option>
                        ...
                        <div className="col">
                            ...
                            <Input id="searchName" name=" searchName" placeholder="Name.." required value={searchName} onChange={event => setSearchName(event.target.value)} />
                        </div>
